...
namespace OpenFreqAudio
{
    ...
    public class AudioParams
    {
        ...
        {
            return $"ReceivedDb: {ReceivedDb}, ReceivedSnrDb: {ReceivedSnrDb}, DropoutRate : {DropoutRate}, DeepFadeRate: {DeepFadeRate}, TuneOffsetPPM: {TuneOffsetPPM}, SignalBlocked: {SignalBlocked}";
        }
